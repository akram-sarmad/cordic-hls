...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "solve_top.autotvin.dat"
	set constFileTvOut       "solve_top.autotvout.dat"
	set constFileHdlTvIn     "solve_top.autohdltvin.dat"
	set constFileHdlTvOut    "solve_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
