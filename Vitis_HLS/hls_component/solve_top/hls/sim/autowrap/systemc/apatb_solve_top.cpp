...
// wrapc file define:
#define AUTOTB_TVIN_A_in "../tv/cdatafile/c.solve_top.autotvin_A_in.dat"
#define AUTOTB_TVOUT_A_in "../tv/cdatafile/c.solve_top.autotvout_A_in.dat"
#define AUTOTB_TVIN_b_in "../tv/cdatafile/c.solve_top.autotvin_b_in.dat"
#define AUTOTB_TVOUT_b_in "../tv/cdatafile/c.solve_top.autotvout_b_in.dat"
#define AUTOTB_TVIN_x_out "../tv/cdatafile/c.solve_top.autotvin_x_out.dat"
#define AUTOTB_TVOUT_x_out "../tv/cdatafile/c.solve_top.autotvout_x_out.dat"
#define AUTOTB_TVIN_done "../tv/cdatafile/c.solve_top.autotvin_done.dat"
#define AUTOTB_TVOUT_done "../tv/cdatafile/c.solve_top.autotvout_done.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_x_out "../tv/rtldatafile/rtl.solve_top.autotvout_x_out.dat"
#define AUTOTB_TVOUT_PC_done "../tv/rtldatafile/rtl.solve_top.autotvout_done.dat"
...
extern "C"
void solve_top_hw_stub_wrapper(void*, void*, void*, void*);

extern "C"
void apatb_solve_top_hw(void* __xlx_apatb_param_A_in, void* __xlx_apatb_param_b_in, void* __xlx_apatb_param_x_out, void* __xlx_apatb_param_done)
{
  ...
  port0.param = __xlx_apatb_param_done;
  ...
  port1.param = { __xlx_apatb_param_A_in };
  port1.mname = { "A_in" };
  port1.nbytes = { 64 };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port2 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_b_in),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_b_in),
#endif
#endif
    .hasWrite = { false },
    .max_nbytes = { 0 },
  };
  port2.param = { __xlx_apatb_param_b_in };
  port2.mname = { "b_in" };
  port2.nbytes = { 16 };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_x_out),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_x_out),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_x_out),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_x_out),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_x_out),
#else
  ...
  port3.param = { __xlx_apatb_param_x_out };
  port3.mname = { "x_out" };
  port3.nbytes = { 16 };
  ...
  try {
    ...
    solve_top_hw_stub_wrapper(__xlx_apatb_param_A_in, __xlx_apatb_param_b_in, __xlx_apatb_param_x_out, __xlx_apatb_param_done);
