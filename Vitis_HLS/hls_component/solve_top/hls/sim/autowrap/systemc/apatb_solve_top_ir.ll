; ModuleID = 'C:/ELEC522/sm512/asdf/Vitis_HLS/hls_component/solve_top/hls/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: inaccessiblemem_or_argmemonly noinline willreturn
define void @apatb_solve_top_ir([4 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="4" %A_in, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="4" %b_in, float* noalias nocapture nonnull "fpga.decayed.dim.hint"="4" %x_out, i16* noalias nocapture nonnull %done) local_unnamed_addr #0 {
entry:
  %0 = bitcast [4 x float]* %A_in to [4 x [4 x float]]*
  %A_in_copy = alloca [4 x [4 x float]], align 512
  %1 = bitcast float* %b_in to [4 x float]*
  %b_in_copy = alloca [4 x float], align 512
  %2 = bitcast float* %x_out to [4 x float]*
  %x_out_copy = alloca [4 x float], align 512
  %done_copy = alloca i16, align 512
  call fastcc void @copy_in([4 x [4 x float]]* nonnull %0, [4 x [4 x float]]* nonnull align 512 %A_in_copy, [4 x float]* nonnull %1, [4 x float]* nonnull align 512 %b_in_copy, [4 x float]* nonnull %2, [4 x float]* nonnull align 512 %x_out_copy, i16* nonnull %done, i16* nonnull align 512 %done_copy)
  call void @apatb_solve_top_hw([4 x [4 x float]]* %A_in_copy, [4 x float]* %b_in_copy, [4 x float]* %x_out_copy, i16* %done_copy)
  call void @copy_back([4 x [4 x float]]* %0, [4 x [4 x float]]* %A_in_copy, [4 x float]* %1, [4 x float]* %b_in_copy, [4 x float]* %2, [4 x float]* %x_out_copy, i16* %done, i16* %done_copy)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_in([4 x [4 x float]]* noalias readonly, [4 x [4 x float]]* noalias align 512, [4 x float]* noalias readonly, [4 x float]* noalias align 512, [4 x float]* noalias readonly, [4 x float]* noalias align 512, i16* noalias readonly, i16* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_out([4 x [4 x float]]* noalias, [4 x [4 x float]]* noalias readonly align 512, [4 x float]* noalias, [4 x float]* noalias readonly align 512, [4 x float]* noalias, [4 x float]* noalias readonly align 512, i16* noalias, i16* noalias readonly align 512) unnamed_addr #4 {
entry:
...
declare void @apatb_solve_top_hw([4 x [4 x float]]*, [4 x float]*, [4 x float]*, i16*)

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_back([4 x [4 x float]]* noalias, [4 x [4 x float]]* noalias readonly align 512, [4 x float]* noalias, [4 x float]* noalias readonly align 512, [4 x float]* noalias, [4 x float]* noalias readonly align 512, i16* noalias, i16* noalias readonly align 512) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a4f32([4 x float]* %4, [4 x float]* align 512 %5)
  call fastcc void @onebyonecpy_hls.p0i16(i16* %6, i16* align 512 %7)
  ret void
...
declare void @solve_top_hw_stub([4 x float]* noalias nocapture nonnull readonly, float* noalias nocapture nonnull readonly, float* noalias nocapture nonnull, i16* noalias nocapture nonnull)

define void @solve_top_hw_stub_wrapper([4 x [4 x float]]*, [4 x float]*, [4 x float]*, i16*) #5 {
entry:
  call void @copy_out([4 x [4 x float]]* null, [4 x [4 x float]]* %0, [4 x float]* null, [4 x float]* %1, [4 x float]* null, [4 x float]* %2, i16* null, i16* %3)
  %4 = bitcast [4 x [4 x float]]* %0 to [4 x float]*
  %5 = bitcast [4 x float]* %1 to float*
  %6 = bitcast [4 x float]* %2 to float*
  call void @solve_top_hw_stub([4 x float]* %4, float* %5, float* %6, i16* %3)
  call void @copy_in([4 x [4 x float]]* null, [4 x [4 x float]]* %0, [4 x float]* null, [4 x float]* %1, [4 x float]* null, [4 x float]* %2, i16* null, i16* %3)
  ret void
}
