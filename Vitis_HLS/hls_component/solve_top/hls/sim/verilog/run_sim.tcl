...
if {[file isfile solve_top.autotvin.dat]} {
	file delete -force solve_top.autotvin.dat
}

if {[file isfile solve_top.autotvout.dat]} {
	file delete -force solve_top.autotvout.dat
}
