# 1 "C:\\ELEC522\\sm512\\asdf\\Vitis\\platform\\hw\\sdt\\system-top.dts"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\ELEC522\\sm512\\asdf\\Vitis\\platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "C:\\ELEC522\\sm512\\asdf\\Vitis\\platform\\hw\\sdt\\zynq-7000.dtsi" 1
# 10 "C:\\ELEC522\\sm512\\asdf\\Vitis\\platform\\hw\\sdt\\zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "C:\\ELEC522\\sm512\\asdf\\Vitis\\platform\\hw\\sdt\\system-top.dts" 2
# 1 "C:\\ELEC522\\sm512\\asdf\\Vitis\\platform\\hw\\sdt\\pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  ...
  solve_top_0: solve_top@40000000 {
   compatible = "xlnx,solve-top-1.0";
   xlnx,ii = "127 , ~ , 1555";
   xlnx,machine = <64>;
   xlnx,ip-name = "solve_top";
   ...
   xlnx,latency = <126>;
   xlnx,name = "solve_top_0";
  };
 };
};
# 4 "C:\\ELEC522\\sm512\\asdf\\Vitis\\platform\\hw\\sdt\\system-top.dts" 2
# 1 "C:\\ELEC522\\sm512\\asdf\\Vitis\\platform\\hw\\sdt\\pcw.dtsi" 1
 &ps7_cortexa9_0 {
...
# 5 "C:\\ELEC522\\sm512\\asdf\\Vitis\\platform\\hw\\sdt\\system-top.dts" 2
/ {
 board = "zed";
 compatible = "xlnx,zed";
 device_id = "7z020";
 ...
 cpus_a9: cpus-a9@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x40000000 &solve_top_0 0x40000000 0x10000>,
