...
#define XPAR_XSOLVE_TOP_NUM_INSTANCES 1

/* Definitions for peripheral SOLVE_TOP_0 */
#define XPAR_SOLVE_TOP_0_COMPATIBLE "xlnx,solve-top-1.0"
#define XPAR_SOLVE_TOP_0_BASEADDR 0x40000000
#define XPAR_SOLVE_TOP_0_HIGHADDR 0x4000ffff

/* Canonical definitions for peripheral SOLVE_TOP_0 */
#define XPAR_XSOLVE_TOP_0_BASEADDR 0x40000000
#define XPAR_XSOLVE_TOP_0_HIGHADDR 0x4000ffff
#define XPAR_XSOLVE_TOP_0_COMPATIBLE "xlnx,solve-top-1.0"
